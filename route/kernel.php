<?php
    ...
    switch($url[2]){
        ...
        case "register": $user->register(ucfirst($_POST['fname']),ucfirst($_POST['mname']),ucfirst($_POST['lname']),$_POST['email'],md5($_POST['password']),$_POST['usertype'],$_POST['lrn']); break;
        ...
        case "updateexaminee": $examinee->updateExaminee( ucfirst($_POST['fname']), ucfirst($_POST['mname']), ucfirst($_POST['lname']), $_POST['birth'], $_POST['lrn'], $_POST['birthplace'], $_POST['religion'], $_POST['nationality'], $_POST['gender'], $_POST['status'], $_POST['contact'], $_POST['email'], $_POST['home'], $_POST['schoollastattend'], $_POST['year'], $_POST['address'], $_POST['foption'], $_POST['soption'], $_POST['toption'], $_POST['image'], $_POST['userid']); break;
